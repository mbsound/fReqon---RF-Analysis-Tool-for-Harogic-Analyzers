...
with zipfile.ZipFile('fcc_temp.zip', 'r') as z:
    with z.open('facility.dat') as f:
        ...
        for line in f:
            ...
            if len(parts) > app_idx and parts[stat_idx] == 'LICENSED':
                fac_app_ids.add(parts[app_idx].strip())
...
print(f"Total LICENSED facility_ids with license_filing_id: {len(fac_app_ids)}")
